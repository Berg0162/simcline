...
// TEST DATA set -----------------------------------------------------
// Test set with Control and 2D Resistance data to be sent to Control Point
...
//    uint32_t tot_Distance = ((byte_MSO << 24) | (byte_MID << 16) | (byte_LSO << 8)) >> 8; // NOT little Endian !!!
    uint32_t tot_Distance = ((byte_LSO << 24) | (byte_MID << 16) | (byte_MSO << 8)) >> 8; // Keep little Endian format
