...
/*
 *         CLIENT: Code to control indoor FTMS trainer
*/
 
/* 
 *  This Feather-nRF52 tested code scans for the CPS, CSC and FTMS
...
#ifdef DEBUG 
  Serial.println("Scanning for CPS and FTMS is stopped!");
#endif    
...
{
  // Client Machine Status data is tranferred to the Server
  // NO TREATMENT OF COMMAND !!!
  // server_FTM_Status_Notify_callback.notify(data, len); // Just pass on and process later!
...
#endif
    // MANDATORY so disconnect since we couldn't find the CPS service
