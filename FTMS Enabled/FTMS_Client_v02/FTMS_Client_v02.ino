...
void Client_Start_Scanning(void)
{
  ...
  Bluefruit.Scanner.restartOnDisconnect(true); // default is true !!! in test stage we do not want to RESTART
...
#ifdef DEBUG  
  Serial.println("Advertising Peripheral with CPS or CSC or FTMS, see the Raw Data packet:");
