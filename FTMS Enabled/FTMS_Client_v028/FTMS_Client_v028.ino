...
#define SOME_TIME 100 // Delay time between SVC and Char discovery calls --> delay(SOME_TIME);
...
#define TIME_SPAN 5000               // Time span (delay) in millis 1000 = 1 second
...
void setup()
{
  ...
  // wait time_span or go on when Client/Central is connected and all set!
  while( (millis() < TimeInterval) ) { 
    yield();
    if(TrainerIsConnected) { break; }
  }
