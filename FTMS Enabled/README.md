...
+ The client-side (Feather nRF52) scans for and connects with <b>FTMS, CPS and CSC</b> and collects cyling power, speed and cadence data like Zwift would do! The code with the name: <b>Test_FTMS_Client_plus_CPS_CSC_v01</b> is doing just that one side of the "bridge"!
