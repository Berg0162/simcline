...
<b>FTMS<\b> is an open (nonproprietary) protocol that is not owned by any particular company and not limited to a particular company's products. It can be compared in that respect with FE-C over Ant+, however FTMS is targeted to control fitness equipment over <b>Bluetooth<\b>!<br>
