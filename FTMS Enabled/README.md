...
# This part is DEPRECATED and NO Longer Maintained!

# After NimBLE-Arduino version 2.x<br>
As of early January 2025 NimBLE-Arduino version 2.x was released and turned out to be **disruptive** for all then existing ESP32 code in this repository. It took quite some effort to make the **simcline** repository accomodate version 2.x. A new `Simcline-V2` repository was created with **redesigned** and **improved** ESP32 code for **FTMS supporting trainers**.<br>
+ Option #1<br>
Keep NimBLE-Arduio version 1.4.3 installed in your Arduino IDE when you want to use the **deprecated** ESP32 code in this originally **FTMS-Enabled** folder of the **simcline** repository!
...
+ Option #2<br>
`Simcline-V2` repository has been published to supersede the deprecated code, checkout: [Simcline-V2](https://github.com/Berg0162/Simcline-V2)<br>

# <img src="https://github.com/Berg0162/simcline/blob/master/images/SC_logo.png" width="64" height="64" alt="SIMCLINE Icon"> &nbsp; SIMCLINE for FTMS enabled Trainers --> NimBLE-Arduino version 1.4.3
