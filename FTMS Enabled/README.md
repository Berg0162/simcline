...
The present code versions do **NOT** support the rebroadcast function of your heart rate sensor. In the Zwift Companion app you’ll see a new option for Zwift hardware and you must switch that function **OFF**, otherwise you will experience unwanted results! Use your heart rate band like everybody else and pair it directly to the controlling app (like Zwift) without any intervention!
