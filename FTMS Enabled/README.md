...
Notice that a fully working Simcline supporting all FTMS enabled Trainers is still in the future. At this moment only test code is available and you are invited to test this code with your FTMS enabled Trainer (if you own one).
