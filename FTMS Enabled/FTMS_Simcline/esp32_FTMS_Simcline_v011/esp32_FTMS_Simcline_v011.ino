...
//#define endian! LAPTOPADDRESS {0x05,0x04,0x03,0x02,0x01,0x00} {0x87,0xB2,0x7E,0xF2,0x86,0x80} {0x95,0x50,0xF3,0xBD,0x6C,0xFD} 
...
void Task_FTM_ControlPoint_Indicate(void *parameter)
{
...
void client_FTM_ControlPoint_Indicate_Callback(BLERemoteCharacteristic* pBLERemoteCharacteristic, uint8_t* pData, size_t length, bool isNotify)
{
  ...
  if((Laptop.IsConnected)) {   
    ...
    xTaskCreate(&Task_FTM_ControlPoint_Indicate, "CP Indicate", 2048, (void *)NULL, 1, &TaskIndicateHandle); 
  }  
