...
const unsigned long TimeSpan = (poll_delay*30 + 2500);  // Unit in millis, Time to wait for client_connect_callback to finish properly
...
#endif 
  // test--------------
  BLEDiscovery* BLEDiscover;
  BLEDiscover->begin();
  DEBUG_PRINTLN("Start BLEDiscovery... does it help ?"); 
