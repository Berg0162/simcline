...
//    { Bluefruit.Advertising.stop(); }
  ...
  Bluefruit.Advertising.setInterval(116, 192);    // 32 244 Advertising Interval and window in units of 0.625 ms (116*0.625 = 72 ; 192*0.625 = 120)
...
void server_connect_callback(uint16_t conn_handle)
{
  ...
  DEBUG_PRINT("Server Connection Parameters -> ");
  ...
  DEBUG_PRINTLN();
#endif
  // Set NEW parameters: Connection Interval, Latency and Supervision Timeout
  // Interval in units of 1.25ms [24]   Latency [0]   Supervision Timeout in units of 10ms [960]
  //if( connection->requestConnectionParameter(48, 0, 960) ) { // Zwift values...
  //  DEBUG_PRINTLN(">>> Request NEW Connection Parameters!");
  //}
  //
