 ...
 *  5) Search on Zwift pairing screens for <SIM32>
 *  6) Pair: Power, Cadence, Heart Rate and Controllable one after another with <SIM32>
...
/*
Version 1.2
Changed device identification naming to a simpler scheme: SIM32 or SIM52
*/
// -------------------------------------------------------------------------------------------
...
*/
uint8_t client_HR_Location_Chr_Value = { 0x01 }; // Chest
// ---------------------------------------------------------------------
...
*/
    void onSubscribe(NimBLECharacteristic* pCharacteristic, ble_gap_conn_desc* desc, uint16_t subValue) {
          String str = "Central Laptop/Zwift Updated CCCD -->";
        if(subValue == 0) {
...
#endif
//----------------------------------------------------  
    DEBUG_PRINTLN("ESP32 NimBLE Server/Peripheral: CPS, CSC, HBM and FTMS");
