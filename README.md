...
The ANT+ FE-C protocol details the bi-directional communication of trainer data (speed, power, etcetera) from trainer to the controller and from the controller to the trainer commands or settings of targeted power, trainer resistance (grade) and calibration controls. See [ThisisAnt]( http://www.thisisant.com/) for all conceivable documentation, tools, implementations, ANT+ based products, etcetera! See also at Github for a detailed description of the [ANT Message Protocol and Usage](https://github.com/Berg0162/simcline/blob/master/docs/ANT_Message_Protocol_and_Usage_Rev_5.1.pdf).
