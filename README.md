...
+ [Visit it at](ai2.appinventor.mit.edu), get started and upload the SIMCLINE Companion App code.
+ Or upload the SIMCLINE Companion App *APK* to your Android device directly.
