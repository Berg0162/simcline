...
// set default value for a flat road = 0% grade --> 20000
  #define MEASUREOFFSET 120 // Difference between reflection plate and central axle position
...
// Safe Range of at least 30 cm
  #define BANDWIDTH 4
  #define MINPOSITION 265 //  New Simcline safe test value // 255 // 265
  #define MAXPOSITION 530 //  New Simcline safe test value // 530 // 525
...
// For testing purpose feed with some data ------------------------------------------------
  ...
  // { 20000, 19500, 20000, 20500, 20000, 19500, 20000, 19500 };
// For testing purpose       --------------------------------------------------------------
...
// To set testing target values -----------------------------------
    if ( (++TargetPositionCount)>7) {TargetPositionCount = 0;}  
    RawgradeValue = TargetValuesArray[TargetPositionCount] - MEASUREOFFSET;
// ---------------------------------------------------------------- 
