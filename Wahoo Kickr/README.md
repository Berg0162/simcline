...
Christian was one of those that have a Wahoo KICKR and built the SIMCLINE design for personal use. However, he could not apply the Simcline code as it was! We have collaborated very closely during a teamwise journey to explore all possible scenarios to realize the SIMCLINE design and code to operate with a Wahoo KICKR trainer, in addition to a TACX trainer! Christian's expertise and effort was focussed on testing with Wahoo KICKR and figure out how communication is implemented. He collected tons of valuable information that helped to pinpoint the solution
