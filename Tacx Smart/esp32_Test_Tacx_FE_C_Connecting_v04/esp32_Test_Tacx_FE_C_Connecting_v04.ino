...
const uint16_t ConnectionMinInterval = 24; 	// The minimum connection interval in 1.25ms units. Min interval (7.5 ms)  was  6 , 24
const uint16_t ConnectionMaxInterval = 48;	// The maximum connection interval in 1.25ms units. Max interval (15 ms)   was 12 , 40
const uint16_t ConnectionLatency = 0;   	  // No slave latency (immediate response)
const uint16_t ConnectionTimeout = 400; 	  // The timeout time in 10ms units before disconnecting. 200 -> 2000 ms     was 200 , 500
...
const uint16_t ConnectionMTU = 96;     	    // ATT (Attribute Protocol) Maximum Transmission Unit                      was 185 , 100
